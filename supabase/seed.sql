...
INSERT INTO public.skills (id, name_fi, name_en, normalized_name) VALUES
  ('a1000000-0000-4000-8000-000000000001', 'React', 'React', 'react'),
  ('a1000000-0000-4000-8000-000000000002', 'TypeScript', 'TypeScript', 'typescript'),
  ('a1000000-0000-4000-8000-000000000003', 'SQL', 'SQL', 'sql'),
  ('a1000000-0000-4000-8000-000000000004', 'Figma', 'Figma', 'figma'),
  ('a1000000-0000-4000-8000-000000000005', 'JavaScript', 'JavaScript', 'javascript'),
  ('a1000000-0000-4000-8000-000000000006', 'Python', 'Python', 'python'),
  ('a1000000-0000-4000-8000-000000000007', 'Node.js', 'Node.js', 'nodejs'),
  ('a1000000-0000-4000-8000-000000000008', 'Docker', 'Docker', 'docker'),
  ('a1000000-0000-4000-8000-000000000009', 'AWS', 'AWS', 'aws')
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.interests (id, name_fi, name_en, normalized_name) VALUES
  ('e1000000-0000-4000-8000-000000000001', 'Web-kehitys', 'Web development', 'web-development'),
  ('e1000000-0000-4000-8000-000000000002', 'Käyttökokemus', 'UX', 'ux'),
  ('e1000000-0000-4000-8000-000000000003', 'Frontend', 'Frontend', 'frontend'),
  ('e1000000-0000-4000-8000-000000000004', 'Data', 'Data', 'data'),
  ('e1000000-0000-4000-8000-000000000005', 'Full-stack', 'Full-stack', 'full-stack'),
  ('e1000000-0000-4000-8000-000000000006', 'Pilvi', 'Cloud', 'cloud'),
  ('e1000000-0000-4000-8000-000000000007', 'Tietoturva', 'Security', 'security')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.student_skills (student_id, skill_id) VALUES
  ('b0000000-0000-4000-8000-000000000011', 'a1000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000011', 'a1000000-0000-4000-8000-000000000002'),
  ('b0000000-0000-4000-8000-000000000011', 'a1000000-0000-4000-8000-000000000003'),
  ('b0000000-0000-4000-8000-000000000011', 'a1000000-0000-4000-8000-000000000004'),
  ('b0000000-0000-4000-8000-000000000012', 'a1000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000012', 'a1000000-0000-4000-8000-000000000005'),
  ('b0000000-0000-4000-8000-000000000013', 'a1000000-0000-4000-8000-000000000006'),
  ('b0000000-0000-4000-8000-000000000014', 'a1000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000014', 'a1000000-0000-4000-8000-000000000002'),
  ('b0000000-0000-4000-8000-000000000014', 'a1000000-0000-4000-8000-000000000007'),
  ('b0000000-0000-4000-8000-000000000015', 'a1000000-0000-4000-8000-000000000006'),
  ('b0000000-0000-4000-8000-000000000015', 'a1000000-0000-4000-8000-000000000008'),
  ('b0000000-0000-4000-8000-000000000015', 'a1000000-0000-4000-8000-000000000009')
ON CONFLICT DO NOTHING;

INSERT INTO public.student_interests (student_id, interest_id) VALUES
  ('b0000000-0000-4000-8000-000000000011', 'e1000000-0000-4000-8000-000000000001'),
  ('b0000000-0000-4000-8000-000000000011', 'e1000000-0000-4000-8000-000000000002'),
  ('b0000000-0000-4000-8000-000000000012', 'e1000000-0000-4000-8000-000000000003'),
  ('b0000000-0000-4000-8000-000000000013', 'e1000000-0000-4000-8000-000000000004'),
  ('b0000000-0000-4000-8000-000000000014', 'e1000000-0000-4000-8000-000000000005'),
  ('b0000000-0000-4000-8000-000000000015', 'e1000000-0000-4000-8000-000000000006'),
  ('b0000000-0000-4000-8000-000000000015', 'e1000000-0000-4000-8000-000000000007')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.project_required_courses (project_id, course_id) VALUES
  ('90000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000002', 'c1000000-0000-4000-8000-000000000003'),
  ('90000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000002'),
  ('90000000-0000-4000-8000-000000000004', 'c1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000006', 'c1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000006', 'c1000000-0000-4000-8000-000000000002'),
  ('90000000-0000-4000-8000-000000000007', 'c1000000-0000-4000-8000-000000000005')
ON CONFLICT DO NOTHING;

INSERT INTO public.project_recommended_courses (project_id, course_id) VALUES
  ('90000000-0000-4000-8000-000000000001', 'c1000000-0000-4000-8000-000000000003'),
  ('90000000-0000-4000-8000-000000000003', 'c1000000-0000-4000-8000-000000000004'),
  ('90000000-0000-4000-8000-000000000007', 'c1000000-0000-4000-8000-000000000006')
ON CONFLICT DO NOTHING;

INSERT INTO public.project_required_skills (project_id, skill_id) VALUES
  ('90000000-0000-4000-8000-000000000001', 'a1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000001', 'a1000000-0000-4000-8000-000000000002'),
  ('90000000-0000-4000-8000-000000000002', 'a1000000-0000-4000-8000-000000000004'),
  ('90000000-0000-4000-8000-000000000003', 'a1000000-0000-4000-8000-000000000003'),
  ('90000000-0000-4000-8000-000000000003', 'a1000000-0000-4000-8000-000000000006'),
  ('90000000-0000-4000-8000-000000000004', 'a1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000004', 'a1000000-0000-4000-8000-000000000002'),
  ('90000000-0000-4000-8000-000000000006', 'a1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000007', 'a1000000-0000-4000-8000-000000000008'),
  ('90000000-0000-4000-8000-000000000007', 'a1000000-0000-4000-8000-000000000009')
ON CONFLICT DO NOTHING;

INSERT INTO public.project_recommended_skills (project_id, skill_id) VALUES
  ('90000000-0000-4000-8000-000000000001', 'a1000000-0000-4000-8000-000000000004'),
  ('90000000-0000-4000-8000-000000000004', 'a1000000-0000-4000-8000-000000000007')
ON CONFLICT DO NOTHING;

INSERT INTO public.project_interests (project_id, interest_id) VALUES
  ('90000000-0000-4000-8000-000000000001', 'e1000000-0000-4000-8000-000000000001'),
  ('90000000-0000-4000-8000-000000000001', 'e1000000-0000-4000-8000-000000000002'),
  ('90000000-0000-4000-8000-000000000007', 'e1000000-0000-4000-8000-000000000006')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.project_weights (
  ...
  ('90000000-0000-4000-8000-000000000001', 10, 20, 10, 25, 10, 10, 10, 5),
  ('90000000-0000-4000-8000-000000000002', 15, 25, 5, 20, 10, 10, 10, 5),
  ('90000000-0000-4000-8000-000000000003', 10, 20, 10, 25, 10, 10, 10, 5),
  ('90000000-0000-4000-8000-000000000004', 10, 15, 10, 30, 15, 5, 10, 5),
  ('90000000-0000-4000-8000-000000000005', 10, 20, 10, 25, 10, 10, 10, 5),
  ('90000000-0000-4000-8000-000000000006', 15, 25, 5, 25, 10, 10, 5, 5),
  ('90000000-0000-4000-8000-000000000007', 10, 20, 10, 30, 5, 10, 10, 5)
